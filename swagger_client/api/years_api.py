...
class YearsApi(object):
    ...
    def years_by_id_get(self, id, **kwargs):  # noqa: E501
        """Rok o wybranym Id / Year with selected Id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.years_by_id_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Id roku / Year Id (required)
        ...
        if kwargs.get('async_req'):
            return self.years_by_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.years_by_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def years_by_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Rok o wybranym Id / Year with selected Id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.years_by_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `years_by_id_get`")  # noqa: E501
    ...
    def years_get(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.years_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.years_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def years_get_with_http_info(self, **kwargs):  # noqa: E501
        """Lista lat obowiązywania danych / List of years of data availability  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.years_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='YearList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def years_metadata_get(self, **kwargs):  # noqa: E501
        """Metadane / Metadata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.years_metadata_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.years_metadata_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.years_metadata_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def years_metadata_get_with_http_info(self, **kwargs):  # noqa: E501
        """Metadane / Metadata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.years_metadata_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method years_metadata_get" % key
                )
            params[key] = val
        del params['kwargs']
