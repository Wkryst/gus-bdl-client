...
class LevelsApi(object):
    ...
    def levels_by_id_get(self, id, **kwargs):  # noqa: E501
        """Poziom obowiązywania o zadanym Id / Availability level with selected Id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.levels_by_id_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Id poziomu / Level Id (required)
        ...
        if kwargs.get('async_req'):
            return self.levels_by_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.levels_by_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def levels_by_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Poziom obowiązywania o zadanym Id / Availability level with selected Id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.levels_by_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method levels_by_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `levels_by_id_get`")  # noqa: E501
    ...
    def levels_get(self, **kwargs):  # noqa: E501
        """Lista poziomów obowiązywania / Availability levels list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.levels_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.levels_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.levels_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def levels_get_with_http_info(self, **kwargs):  # noqa: E501
        """Lista poziomów obowiązywania / Availability levels list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.levels_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LevelList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def levels_metadata_get(self, **kwargs):  # noqa: E501
        """Metadane / Metadata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.levels_metadata_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.levels_metadata_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.levels_metadata_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def levels_metadata_get_with_http_info(self, **kwargs):  # noqa: E501
        """Metadane / Metadata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.levels_metadata_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method levels_metadata_get" % key
                )
            params[key] = val
        del params['kwargs']
